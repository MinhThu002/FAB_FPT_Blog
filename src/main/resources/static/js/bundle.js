...
(function(){
    var location = window.location.href,
    	$ttDesctopMenu = $('#tt-header.html .tt-desktop-menu');
...
*/
(function(){
    var ttSearchWrapper = $('#tt-header.html .tt-search'),
